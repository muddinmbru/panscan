...
my $resultfile1 = "$sample\_single_allelic.vcf";
my $resultfile2 = "$sample\_single_allelic_decomposed.vcf";
my $resultfile3 = "$sample\_single_allelic_decomposed_GT_Merged.vcf";
